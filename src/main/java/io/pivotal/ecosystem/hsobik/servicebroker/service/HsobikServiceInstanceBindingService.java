package io.pivotal.ecosystem.hsobik.servicebroker.service;
...
@Service
public class HsobikServiceInstanceBindingService implements ServiceInstanceBindingService {
	...
	public CreateServiceInstanceBindingResponse createServiceInstanceBinding(
		...
		return CreateServiceInstanceAppBindingResponse.builder().credentials("url", url)
				.credentials("username", bindingUsername).credentials("password", bindingPassword).bindingExisted(false)
				.build();
	}
	...
	public GetServiceInstanceBindingResponse getServiceInstanceBinding(GetServiceInstanceBindingRequest request) {
		...
		return GetServiceInstanceAppBindingResponse.builder().credentials("username", bindingUsername)
				.credentials("password", bindingPassword).credentials("url", url).build();
	}
}
